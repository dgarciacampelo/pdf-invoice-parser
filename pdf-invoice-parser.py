...
# * Benchmark decorator for async functions, rounding to 3 decimal places
def benchmark_async_decorator(func):
...
async def process_pdf(pdf_file, found_cups, pending_cups_data, threshold):
    ...
    try:
        ...
        # * Check if the threshold is reached, if so, save data to XLSX file
...
# * Run the main function, applying the benchmark decorator
@benchmark_async_decorator
async def main():
